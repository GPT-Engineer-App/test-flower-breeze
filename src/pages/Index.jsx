        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <p>
              ...
              breeds with different characteristics, sizes, and temperaments.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <ul className="list-disc pl-6">
              ...
              <li>Wide range of sizes, from tiny Chihuahuas to large Great Danes</li>
              <li>Diverse coat types, colors, and patterns</li>
